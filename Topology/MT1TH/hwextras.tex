...
\newcommand{\Int}{\ensuremath{\mathrm{Int}\;}} % Gives you a shortcut for writing the blackboard C for the complex numbers - \CC
\newcommand{\Ext}{\ensuremath{\mathrm{Ext}\;}} % Gives you a shortcut for writing the blackboard C for the complex numbers - \CC
